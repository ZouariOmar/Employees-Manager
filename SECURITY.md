# Security Policy for Employees Manager

## Supported Versions

The Employees Manager project provides security updates for the following versions:
...
If you discover a security vulnerability in Employees Manager, we encourage responsible disclosure. To report a vulnerability:
...
We appreciate the security community's efforts in helping us maintain Employees Manager’s safety and integrity.

## Security Practices

Employees Manager follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- Employees Manager uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance Employees Manager's security by following these practices:
...
Thank you for helping us make Employees Manager secure for our users and the community!
